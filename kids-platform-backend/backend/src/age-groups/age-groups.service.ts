/**
 * ФАЙЛ: `src/age-groups/age-groups.service.ts`.
...
@Injectable()
// AgeGroupsService: клас, що інкапсулює відповідальність цього файлу та координує роботу методів.
export class AgeGroupsService {
  constructor(private readonly prisma: PrismaService) {}

  // Метод `findAll(без параметрів)`: обробляє частину бізнес-логіки; отримує дані, викликає залежності та повертає результат.
  async findAll() {
