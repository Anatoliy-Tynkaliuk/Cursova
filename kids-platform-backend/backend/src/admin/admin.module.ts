/**
 * 📘 ОГЛЯД ФАЙЛУ: `kids-platform-backend/backend/src/admin/admin.module.ts`.
...
// Клас: AdminModule. Об'єднує пов'язану логіку та методи в одному модулі для зрозумілого керування поведінкою.
