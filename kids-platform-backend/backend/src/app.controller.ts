/**
 * 📘 ОГЛЯД ФАЙЛУ: `kids-platform-backend/backend/src/app.controller.ts`.
...
@Controller()
// Клас: AppController. Об'єднує пов'язану логіку та методи в одному модулі для зрозумілого керування поведінкою.
