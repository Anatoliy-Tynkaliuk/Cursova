...
VALUES
  ('FINISHED_1', 'Перший старт', 'Заверши свою першу гру', '🚀'),
  ('FINISHED_5', 'Підкорювач рівнів', 'Заверши 5 ігор', '🎮'),
  ('STARS_30', 'Колекціонер зірок', 'Зароби 30 зірок у вправах', '⭐'),
  ('STARS_100', 'Галактична слава', 'Зароби 100 зірок', '🌟'),
  ('LOGIN_DAYS_3', 'Повернення героя', 'Зайди на платформу в 3 різні дні', '📅'),
  ('CORRECT_ANSWERS_25', 'Розумник', 'Дай 25 правильних відповідей', '✅'),
  ('TOTAL_ATTEMPTS_20', 'Наполегливий дослідник', 'Зроби 20 спроб у різних іграх', '🧩'),
  ('PERFECT_GAMES_3', 'Ідеальна серія', 'Пройди 3 гри без помилок', '🏆')
