/**
 * 📘 ОГЛЯД ФАЙЛУ: `kids-platform-frontend/app/child/math/page.tsx`.
...
// Функція: MathPlanetPage. Крок за кроком приймає вхідні дані, перевіряє їх та повертає прогнозований результат.
